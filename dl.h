...
extern dl_t dl_alloc(void);
extern void dl_delete(dl_t dl, dl_el *el);
extern void dl_clear(dl_t dl);
extern void dl_concat(dl_t list1, dl_t list2);
extern void dl_sort(dl_t dl, size_t el_size, int(*compar)(void *, void *));
